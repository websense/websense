...
// define('TTF_DIR','/usr/share/fonts/TrueType/');
  //assume called from ajax subdirectory
define('TTF_DIR','../jpgraph-3.5.0b1/src/truetype/');
...
// Default theme class name - turn off theme
//define('DEFAULT_THEME_CLASS', 'UniversalTheme'); 
//don't use UniversalTheme because watery colours and antialiasing
//WebSense theme has thicker lines, light blue for bar charts (rain) 
//and an earth pallette for line graph colours
define('DEFAULT_THEME_CLASS', 'WebSenseTheme');
